    ...
    class Settings : State
    {
        ...
        public Settings(StateManager Father)
        {
            ...
            SongSlider = new Slider(Manager.Game.Content.Load<Texture2D>("Slider"), Manager.Game.Content.Load<Texture2D>("SliderBar"),
                MediaPlayer.Volume * 10, new Vector2(), new Vector2(150, 350), 150, string.Empty);

            SongSlider.Position = new Vector2(150 + (SongSlider.Value * 10), 285);
            ...
            SoundEffectSlider = new Slider(Manager.Game.Content.Load<Texture2D>("Slider"), Manager.Game.Content.Load<Texture2D>("SliderBar"),
                SoundEffect.MasterVolume * 10, new Vector2(), new Vector2(500, 350), 500, string.Empty);

            SoundEffectSlider.Position = new Vector2(500 + (SoundEffectSlider.Value * 10), 285);
            ...
            switch (StateManager.CurrentLanguage)
            {
                case GameLanguage.English:
                    ...
                    if (StateManager.HasVibrationControl)
                    {
                        ...
                        ("English/Buttons/Pause/VibrationOn"), new Vector2(325, 100));
                    }
                    else
                    {
                        VibrationButton = new Button(Manager.Game.Content.Load<Texture2D>
                        ("English/Buttons/Pause/VibrationOff"), new Vector2(325, 100));
                    }
                ...
                case GameLanguage.Portugues:
                    ...
                    {
                        VibrationButton = new Button(Manager.Game.Content.Load<Texture2D>
                        ("Portugues/Botoes/Pausa/ComVibracao"), new Vector2(325, 100));
                    }
                    else
                    {
                        VibrationButton = new Button(Manager.Game.Content.Load<Texture2D>
                        ("Portugues/Botoes/Pausa/SemVibracao"), new Vector2(325, 100));
                    }
